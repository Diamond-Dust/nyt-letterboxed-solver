...
class LetterboxedSolver:
    ...
    def cut_down_words(self):
        ...
        # 04.09.2024 data
        self.words = ["MISTO", "CHI", "CHIS", "CHIC", "CHICHI", "CHICHIS", "CHICK", "CHICKS", "CHIKO", "CHIT", "CHITS", "CHUM", "CHUMS", "CHUTIST", "CHUTISTS", "CHYMOUS", "CIS", "CISCO", "CIST", "KIST", "CISTS", "KISTS", "CISTUS", "CITY", "COCK", "COCKS", "COCKY", "COCO", "COITUS", "COMIC", "COMICS", "COMITY", "MOTO", "COT", "COTS", "COTCH", "KOTCH", "COUSCOUS", "COUTH", "COUTHY", "COY", "COZ", "CYST", "CYSTS", "CYSTIC", "CYSTITIS", "CYSTOTOMY", "CYTISUS", "SICH", "STICK", "HIC", "HICK", "HICKS", "HIKOI", "HIKOIS", "HIM", "HIS", "HIST", "HIT", "HITS", "HITCH", "HUH", "HUI", "HUIS", "HUKOU", "HUKOUS", "HUM", "HUMS", "HUMIC", "HUMOUS", "HUMUS", "HUSK", "HUSKS", "HUSKY", "HUT", "HUTS", "HUTCH", "ICHTHUS", "ICHTHYOTIC", "ICK", "ICKY", "ICTUS", "ICY", "IMU", "IMUS", "SITU", "TOTO", "ISCHIUM", "ISM", "ISMS", "IST", "ISTS", "ISTHMUS", "ISTHMI", "ITCH", "ITCHY", "ITS", "JISM", "JIT", "JISMS", "JOCK", "JOCKS", "JOIST", "JOISTS", "JOKY", "JOT", "JOTS", "JOUST", "JOUSTS", "JOY", "JOYS", "JOYOUS", "JOYSTICK", "JOYSTICKS", "JOUK", "JOUKS", "KICK", "KICKS", "KICKOUT", "KICKOUTS", "KICKY", "KIKOI", "KIKOIS", "KIKUYU", "KIKUYUS", "KIMCHI", "KIT", "KITS", "KITH", "KITSCH", "KITSCHY", "KOI", "KOJI", "KOTO", "KUMIS", "KUKU", "KUKUS", "KUSTI", "KUSTIS", "KYU", "KYUS", "MCS", "MIC", "MICS", "MICK", "MICKS", "MICKY", "MIHI", "MIHIS", "MIM", "MIMI", "MIMIS", "MIMIC", "MIMICS", "MIMSY", "MIOTIC", "MYOTIC", "MISCH", "MISKICK", "MISKICKS", "MIST", "MISTS", "MISTY", "MITCH", "MITOTIC", "MOC", "MOCS", "MOCHY", "MOCK", "MOCKS", "MOCKY", "MOCOCK", "MOCOCKS", "MOI", "MOIST", "MOISTY", "MOIT", "MOITS", "MOJITO", "MOJO", "MOKO", "MOM", "MOMS", "MOMISM", "MOMO", "MOT", "MOTS", "MOTH", "MOTHY", "MOTU", "MOUSY", "MOUTH", "MOUTHY", "MOZO", "MUS", "MUM", "MUMS", "MUMSY", "MUSIC", "MUSICSTICK", "MUSICSTICKS", "MUSK", "MUSKS", "MUSKY", "MUST", "MUSTS", "MUSTH", "MUSTY", "MUTCH", "MUTI", "MUTISM", "MUZHIK", "MUZHIKS", "MYCOTIC", "MYOTIS", "MYSTIC", "MYSTICS", "MYSTICISM", "MYTH", "MYTHI", "MYTHIC", "MYTHICISM", "MYTHICIST", "MYTHICISTS", "MYTHUS", "OCH", "OCKY", "OIK", "OICK", "OIKS", "OICKS", "OMS", "OMIT", "OMITS", "CIT", "OTIC", "OTITIS", "OTOCYST", "OTOCYSTS", "OUS", "OUST", "OUSTS", "OUT", "OUTS", "OUTHIT", "OUTHITS", "OUTY", "OUTSIT", "OUTSITS", "OUZO", "STOCK", "STOCKS", "UOMO", "SCHISM", "SCHISMS", "SCHIST", "SCHISTS", "SCHISTOUS", "SCHMICK", "SCHMO", "SCHMUTZ", "SCOT", "SCOTS", "SCOTCH", "SCOUT", "SCOUTS", "SCHTICK", "SCHTICKS", "SCHTUM", "SCHTUMS", "SIC", "SICS", "SICK", "SICKS", "SICKO", "SICKOUT", "SICKOUTS", "SIM", "SIMS", "SIS", "SIT", "SITS", "SITCH", "SITCOM", "SITCOMS", "SITUS", "SITZ", "SKI", "SKIS", "SKIM", "SKIMS", "SKIMO", "SKIT", "SKITS", "SKITCH", "SKY", "JIM", "SMICK", "SMICKS", "SMIT", "SMITCH", "SMITH", "SMITHY", "SMOCK", "SMOCKS", "SMOKO", "SMOKY", "SMUT", "SMUTS", "SUK", "SUKH", "SUKS", "STICKS", "STICKUM", "STICKUMS", "STICKY", "STITCH", "STOCIOUS", "STOCKIST", "STOCKISTS", "STOCKOUT", "STOCKOUTS", "STOCKY", "STOIC", "STOICS", "STOICISM", "STOT", "STOTS", "STOUT", "STOUTS", "STUM", "STUMS", "STY", "SUH", "SUI", "SUIT", "SUITS", "SUM", "SUMS", "SUMI", "SUMO", "SUS", "TCH", "THICK", "THICKO", "THIS", "THUS", "THY", "THYMY", "THYMI", "THYMIC", "THYMUS", "TIC", "TICS", "TICK", "TICKS", "TIK", "TIKI", "TIKIS", "TIMOTHY", "TIT", "TITS", "TITCH", "TICH", "TITCHY", "TITI", "TITIS", "TOCHUS", "TOCO", "TOKOTOKO", "TOM", "TOMS", "TOMOZ", "TOT", "TOTS", "TOTY", "TOUT", "TOUTS", "TOY", "TOYS", "TSK", "TUI", "TUIS", "TUKUTUKU", "TUM", "TUMS", "TUSK", "TUSKS", "TUSKY", "TUT", "TUTS", "TUTU", "TUTUS", "TYCHISM", "UHUH", "UMU", "UMUS", "YOCK", "YOCKS", "YOK", "YOKS", "YOICKS", "YOU", "YOUS", "YOUTH", "YOYO", "YUK", "YUKS", "YUH", "YUM", "YUS", "YUZU", "YUZUS", "ZHUZH", "ZOIC", "ZOUK", "HIJIKI", "HIJIKIS", "MOCHI", "MOCHIS", "OIS", "OYS", "CHYMIC", "HISTIC", "HISTIOCYTIC", "JITI", "CHITI", "JITIS", "MICHI", "MICHIS", "MICTIC", "MIJO", "MIKO", "MISKY", "MITY", "MITOUT", "MOCH", "MOKI", "MOCO", "MOITY", "MOKIS", "MOKIHI", "MOKIHIS", "MOKIMOKI", "MOKUS", "MOKY", "MUI", "MOY", "MOU", "MOUS", "MUKIM", "MUKIMS", "MUSICIST", "MUSICISTS", "MUSICO", "MUSTIT", "MUTIC", "MUTICOUS", "MUTUM", "MUTUMS", "MYCOMYSTICISM", "MYCOMYSTICISMS", "MYOTOMIC", "MYOTOMY", "MYSTICIST", "MYSTICISTS", "MYSTICITY", "MYTHISM", "MYTHISMS", "MYTHY", "OCTIC", "OCTICS", "OIKIST", "OMI", "OMIS", "OMOCHI", "OMOCHIS", "OTIUM", "OTIUMS", "OUI", "OUSTITI", "OUSTITIS", "SMITHUM", "STICKIT", "SUKI", "SUKIS", "TIMIST", "TIMISTS", "TITHI", "THITHI", "TITHIS", "TOITY", "TOMIUM", "TOMIUMS", "TOMO", "YOICK", "YOIK"]
    ...
    @staticmethod
    def count_repetitions_iterative(word, old_letters_left):
        # Check how many letters current sequence is using
        letters_used = Counter(word)
        # We should not count the joint letters twice.
        letters_used[word[0]] -= 1
        letters_left = old_letters_left.copy()
        letters_left.update({k: -v for k, v in letters_used.items()})
            ...
            if repetitions <= allowed_repetitions:
                ...
                # We can test the next step
                    ...
                    possible_next_words = list(filter(
                        lambda next_word: self.count_repetitions_iterative(next_word, letters_left)[0] <= allowed_repetitions,
...
if __name__ == '__main__':
    ls = LeastRepetitionsLeastWordsSolver(
        ...
        sides=["YZI", "KMT", "OHS", "JUC"],  # 04.09.2024
        threads=12
    )
